...
async fn parse_inline() -> pinnacle_core::models::ReadmeData {
...
async fn parse_str(html: &str, tag: &str) -> pinnacle_core::models::ReadmeData {
...
async fn parse_html(html: &str) -> pinnacle_core::models::ReadmeData {
