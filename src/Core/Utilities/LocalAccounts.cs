...
public static class LocalAccounts
{
    ...
    public static Task<string?> CreateUserAsync(string username, string password, string? why = null) =>
        Remediation.ApplyAsync(
            target: $"Account {username}",
            intent: why is null
    ...
    public static Task<string?> AddToGroupAsync(string username, string group, string? why = null) =>
        Remediation.ApplyAsync(
