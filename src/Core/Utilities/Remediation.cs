// =============================================================================
// CyberPatriot Automation Tool - Prove-and-record wrapper for every change
...
public static class Remediation
{
    ...
    /// </remarks>
    public static void RecordFinding(string target, string intent, bool compliant, string evidence) =>
        RunLog.RecordFix(
            target,
            intent,
            NotRead,
